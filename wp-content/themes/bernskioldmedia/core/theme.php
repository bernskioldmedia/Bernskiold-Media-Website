...
class Ilmenite_Framework {
	...
	function constants($options) {
		...
		// Don't load Language Selector stylesheet
	...
	function theme_support() {
		...
		if(function_exists('add_theme_support')) {
			...
			// Add Image Sizes
			add_image_size( 'blog-thumbnail', 700, 400, false );
			add_image_size( 'fp-blog-thumbnail', 430, 170, true );
		}
		...
		if(function_exists('register_sidebar')) {
			...
			register_sidebar(array(
				'id' => 'sidebar',
				'name' => __('Sidebar', 'bernskioldmedia'),
	...
	function functions() {
		...
		// Scripts, styles and favicon
		require_once( THEME_FUNCTIONS . '/scripts-styles.php' );

		// Load Transient Queries
	...
	function language(){
		...
		load_theme_textdomain( 'bernskioldmedia', THEME_DIR . '/languages' );
