...
if ( ! function_exists( 'bm_get_transient_query' ) ) :
/**
 ...
 */
function bm_get_transient_query( $transient_name, $query_args, $transient_time = HOUR_IN_SECONDS ) {
...
if ( ! function_exists( 'bm_get_transient_posts' ) ) :
/**
 ...
 * @param  int 	$transient_time A time for how long the data should be cached.
 */
function bm_get_transient_posts( $transient_name, $query_args, $transient_time = HOUR_IN_SECONDS ) {
...
if ( ! function_exists( 'bm_get_transient_terms' ) ) :
function bm_get_transient_terms( $transient_name, $taxonomy_name, $taxonomy_args = '', $transient_time = HOUR_IN_SECONDS ) {
