...
get_header(); ?>
    ...
    <div class="hero-service-selector">
        <ul>
          <li><a href="<?php echo home_url( ICL_LANGUAGE_CODE . '/services/' ); ?>"><i class="fa fa-2x fa-cogs"></i> <?php _e( 'Web Strategy', 'bernskioldmedia' ); ?></a></li>
          <li><a href="<?php echo home_url( ICL_LANGUAGE_CODE . '/services/' ); ?>"><i class="fa fa-2x fa-code"></i> <?php _e( 'Design & Development', 'bernskioldmedia' ); ?></a></li>
          <li><a href="<?php echo home_url( ICL_LANGUAGE_CODE . '/services/' ); ?>"><i class="fa fa-2x fa-shopping-cart"></i> <?php _e( 'e-Commerce', 'bernskioldmedia' ); ?></a></li>
          <li><a href="<?php echo home_url( ICL_LANGUAGE_CODE . '/services/' ); ?>"><i class="fa fa-2x fa-users"></i> <?php _e( 'Education', 'bernskioldmedia' ); ?></a></li>
        </ul>
      </div>
      ...
      <div class="page-section-bordered">
        ...
        <div class="row page-section-3x">
          ...
          <div class="small-24 medium-24 large-8 columns text-center">
            ...
            <p><a href="<?php echo home_url( ICL_LANGUAGE_CODE . '/services/' ); ?>" class="button"><?php _e( 'More Web Strategy', 'bernskioldmedia' ); ?></a></p>
          </div>
          <div class="small-24 medium-12 large-8 columns text-center">
            ...
            <p><a href="<?php echo home_url( ICL_LANGUAGE_CODE . '/services/' ); ?>" class="button"><?php _e( 'More Design & Development', 'bernskioldmedia' ); ?></a></p>
          </div>
          <div class="small-24 medium-12 large-8 columns text-center">
            ...
            <p><a href="<?php echo home_url( ICL_LANGUAGE_CODE . '/services/' ); ?>" class="button"><?php _e( 'More Education', 'bernskioldmedia' ); ?></a></p>
          </div>
        </div>
