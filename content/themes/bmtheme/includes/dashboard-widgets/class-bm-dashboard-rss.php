...
if ( ! class_exists( 'BM_Dashboard_RSS' ) ) :
     ...
     class BM_Dashboard_RSS {
          ...
          function dashboard_widget_config() {
               ...
               wp_add_dashboard_widget( 'dashboard_custom_feed', esc_html__( 'From the Bernskiold Media Academy', 'bmtheme' ), array( $this, 'widget_output' ) );
          }
          ...
          public function widget_output() {
               ...
               echo '<div class="rss-widget">';
                    ...
                    wp_widget_rss_output(array(
                         'url'          => _x( 'https://www.bernskioldmedia.com/en/feed/', 'bernskiold media rss feed url', 'bmtheme' ),
                         'title'        => esc_html__( 'From the Bernskiold Media Academy', 'bmtheme' ),
                         'items'        => 4,
                         'show_summary' => 1,
                         'show_author'  => 0,
                         'show_date'    => 0,
