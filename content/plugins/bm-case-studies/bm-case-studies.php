<?php
/*
 * Plugin Name: BM: Case Studies
 * Plugin URI:  https://www.bernskioldmedia.com
 * Description: A bespoke WordPress plugin to handle the case studies functionality.
 * Version:     1.0
 * Author:      Bernskiold Media
 * Author URI:  https://www.bernskioldmedia.com
 * Text Domain: bm-case-studies
...
class Plugin {
	...
	protected function load_post_types() {
		...
		// Load Custom Post Type "Case Studies".
		require_once( 'classes/post-types/cpt-case-studies.php' );
		new CPT_Case_Studies;
	...
	public function languages() {
		...
		load_plugin_textdomain( 'bm-case-studies', false, dirname( plugin_basename( __FILE__ ) ) . '/languages/' );
