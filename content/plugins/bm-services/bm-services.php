<?php
/*
 * Plugin Name: BM: Services
 * Plugin URI:  https://www.bernskioldmedia.com
 * Description: A bespoke WordPress plugin to handle the services functionality.
 * Version:     1.0
 * Author:      Bernskiold Media
 * Author URI:  https://www.bernskioldmedia.com
 * Text Domain: bm-services
...
class Plugin {
	...
	protected function load_post_types() {
		...
		// Load Custom Post Type "Services".
		require_once( 'classes/post-types/cpt-services.php' );
		new CPT_Services;
	...
	protected function load_taxonomies() {
		...
		// Load Taxonomy "Areas".
		require_once( 'classes/taxonomies/tax-areas.php' );
		new Tax_Areas;
	...
	public function languages() {
		...
		load_plugin_textdomain( 'bm-services', false, dirname( plugin_basename( __FILE__ ) ) . '/languages/' );
