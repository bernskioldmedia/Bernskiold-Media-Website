<?php
/*
 * Plugin Name: BM: Testimonials
 * Plugin URI:  https://www.bernskioldmedia.com
 * Description: A bespoke WordPress plugin to handle the testimonials functionality.
 * Version:     1.0
 * Author:      Bernskiold Media
 * Author URI:  https://www.bernskioldmedia.com
 * Text Domain: bm-testimonials
...
class Plugin {
	...
	protected function load_post_types() {
		...
		require_once( 'classes/post-types/cpt-testimonials.php' );
	...
	public function languages() {
		...
		load_plugin_textdomain( 'bm-testimonials', false, dirname( plugin_basename( __FILE__ ) ) . '/languages/' );
