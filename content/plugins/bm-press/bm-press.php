<?php
/*
 * Plugin Name: BM: Press
 * Plugin URI:  https://www.bernskioldmedia.com
 * Description: A bespoke WordPress plugin to handle the press functionality.
 * Version:     1.0
 * Author:      Bernskiold Media
 * Author URI:  https://www.bernskioldmedia.com
 * Text Domain: bm-press
...
class Plugin {
	...
	public function languages() {
		...
		load_plugin_textdomain( 'bm-press', false, dirname( plugin_basename( __FILE__ ) ) . '/languages/' );
