<?php
/*
 * Plugin Name: BM: Clients
 * Plugin URI:  https://www.bernskioldmedia.com
 * Description: A bespoke WordPress plugin to handle the clients functionality.
 * Version:     1.0
 * Author:      Bernskiold Media
 * Author URI:  https://www.bernskioldmedia.com
 * Text Domain: bm-clients
...
class Plugin {
	...
	protected function load_post_types() {
		...
		// Load Custom Post Type "Clients".
		require_once( 'classes/post-types/cpt-clients.php' );
		new CPT_Clients;
	...
	public function languages() {
		...
		load_plugin_textdomain( 'bm-clients', false, dirname( plugin_basename( __FILE__ ) ) . '/languages/' );
